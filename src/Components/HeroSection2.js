...
export default function AccidentClaimPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const emailResult = await sendStepperFormEmail(formData, "Hero Section 2")
      
      if (emailResult.success) {
        console.log("Email sent successfully")
        
        // Only reset form and go to step 1 for final submissions
        if (currentStep === 6 || formData.contactPreference === "call-now") {
      ...
      case 5:
        return (
          <div className="space-y-6 min-h-[400px] flex flex-col justify-center">
            <div>
              {/* <h3 className="text-lg font-semibold text-gray-800 mb-4 text-center">
                Were <span className="text-red-600">You Insured</span> At The Time Of The Accident?
              </h3> */}
              {/* <h4 className="text-base font-semibold text-blue-800 mb-6 text-center">
                Were You Insured At The Time Of The Accident?
              </h4> */}
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-gray-600 text-center">
                    We'll call you at your preferred time. If you need to reschedule, please contact us at (XXX)XXX-XXXX.
                  </p>
                </div>
              </div>
            ) : (
  ...
  return (
    <div style={{height: '120vh'}} className="min-h-screen relative">
      {/* Background Image */}
      <div 
        className="absolute inset-0 bg-cover bg-center bg-no-repeat"
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(${BgImg})`, height: '120vh'
        }}
      />
      
      {/* Content */}
      <div style={{height: '120vh'}} className="relative z-10 min-h-screen flex items-center">
        <div className="container mx-auto px-4 py-8">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-2xl w-[400px] mx-auto lg:mx-0 lg:ml-auto h-[680px] flex flex-col">
                ...
                {currentStep < 5 ? (
                  ...
                  >
                    {isLoading ? (
                      ...
                      <>
                        <span>{formData.contactPreference === "call-now" ? "Call Now" : "Next"}</span>
                        <ArrowRight className="w-4 h-4" />
                      </>
                    )}
                  </button>
                  ...
                  >
                    {isLoading ? (
                      ...
                      <>
                        <span>{formData.contactPreference === "schedule-call" ? "Schedule Call" : "Submit"}</span>
