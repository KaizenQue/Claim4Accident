...
export default function LegalLandingPage3() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const emailResult = await sendStepperFormEmail(formData, "Colorado Landing Page")
  ...
  const stateData = [
    ...
    { id: "NV", name: "Colorado", cities: ["Las Vegas", "Reno"], highlighted: true },
                ...
                {!showForm ? (
                  <>
                    <Typography variant="h3" sx={{ 
                      ...
                      Injured in a <span style={{ color: '#D14836' }}>Colorado </span> Car Accident?
                    ...
                    {/* <Typography variant="body1" sx={{ 
                      ...
                      A crash can leave you hurt, confused, and overwhelmed with bills. Whether it happened on I-15, I-80, or a city street, we help Coloradons take back control. You heal — we'll deal with the insurance fight.
                    </Typography> */}
                    ...
                    {/* <Box sx={{ mt: 4, textAlign: 'center' }}>
                      <Typography variant="body2" sx={{ 
                        ...
                        Serving over 100 Colorado communities. Thousands of claims filed. 24/7 case support.
                      </Typography>
                    </Box> */}
                  </>
                ) : (
