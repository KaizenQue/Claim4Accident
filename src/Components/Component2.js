...
//       setSuccessMessage(`Great, ${formData.firstName}! We'll be in touch in the next few minutes or if this is more urgent you can call us now xxx xxx xxxx.`);
...
//         className="border-2 border-dashed border-black bg-[#fef2f2] text-[#D9534F] px-6 py-3 font-semibold uppercase transition-all duration-300
//     shadow-[4px_4px_0px_#D9534F] rounded-md
//     hover:brightness-105
//     active:translate-x-0 active:translate-y-0 active:shadow-none active:rounded-none"
//       >
//         Check Eligibility
//       </button>
...
//                 className={`flex-1 py-2 md:py-3 px-4 md:px-6 rounded font-semibold transition-colors text-xs md:text-sm ${isSubmitting
...
//                 <a
//                   href={`mailto:?subject=Check out this legal assistance page&body=I found this helpful, you might too: ${typeof window !== "undefined" ? window.location.href : ""
//                     }`}
...
//                   }}
//                   disabled={copied}
//                   className={`p-4 border-2 border-dashed rounded-lg transition-all duration-300 transform hover:-translate-y-1 font-semibold text-lg text-gray-700 disabled:opacity-50 disabled:cursor-not-allowed ${copied
